...
class GenerateMosaic:
    ...
    def __init__(self, parent_folder, img_name_list, img_dict):
        ...
        self.sifted_img_id_stack = []
        for img_id in range(len(self.img_name_list) - 2,-1,-1):
            self.sifted_img_id_stack.append(img_id)
    ...
    def siftcal(self, thread_id):
        print("\nThread : ", thread_id)
        while len(self.sifted_img_id_stack) > 0:
            ...
            try:
                ...
                self.sifted_img_id_stack.append(i)
                print("self.sifted_img_id_stack : ", self.sifted_img_id_stack)
    ...
    def mosaic(self):
        ...
        stitch_thread = threading.Thread(target=self.calstitch, args=(H_all, result_fldr, ))
