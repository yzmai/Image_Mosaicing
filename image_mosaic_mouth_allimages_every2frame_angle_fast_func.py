...
if __name__ == "__main__":
    if platform.system() == 'Windows':
        parent_folder = r"D:\Ynby\Git\Image-Mosaicing-master\input\mouth\videomouth2\fastresults"
    else:
        parent_folder = r"/data/mouth/videomouth2\fastresults"
    ...
    img_name_list=img_name_list[0:2]
